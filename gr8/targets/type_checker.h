// $Id: type_checker.h,v 1.7 2018/05/16 17:43:04 ist424865 Exp $ -*- c++ -*-
...
namespace gr8 {
  ...
  protected:
    void processBinaryInteger(cdk::binary_expression_node * const node, int lvl);
    void processBinaryIntegerDouble(cdk::binary_expression_node * const node, int lvl);
    void processUnaryExpression(cdk::unary_expression_node * const node, int lvl);
    bool pointerComparator(basic_type *first, basic_type *second);
    template<typename T>
