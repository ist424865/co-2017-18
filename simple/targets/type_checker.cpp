...
void simple::type_checker::do_sequence_node(cdk::sequence_node * const node, int lvl) {
  // EMPTY
}

//---------------------------------------------------------------------------

void simple::type_checker::do_nil_node(cdk::nil_node * const node, int lvl) {
  // EMPTY
}
void simple::type_checker::do_data_node(cdk::data_node * const node, int lvl) {
  // EMPTY
}
void simple::type_checker::do_double_node(cdk::double_node * const node, int lvl) {
  // EMPTY
}
void simple::type_checker::do_not_node(cdk::not_node * const node, int lvl) {
  // EMPTY
}
void simple::type_checker::do_and_node(cdk::and_node * const node, int lvl) {
  // EMPTY
}
void simple::type_checker::do_or_node(cdk::or_node * const node, int lvl) {
  // EMPTY
}
...
void simple::type_checker::processUnaryExpression(cdk::unary_expression_node * const node, int lvl) {
...
void simple::type_checker::processBinaryExpression(cdk::binary_expression_node * const node, int lvl) {
  ASSERT_UNSPEC;
...
void simple::type_checker::do_identifier_node(cdk::identifier_node * const node, int lvl) {
  ASSERT_UNSPEC;
...
void simple::type_checker::do_rvalue_node(cdk::rvalue_node * const node, int lvl) {
  ASSERT_UNSPEC;
  try {
...
void simple::type_checker::do_assignment_node(cdk::assignment_node * const node, int lvl) {
  ASSERT_UNSPEC;

  try {
    node->lvalue()->accept(this, lvl);
  } catch (const std::string &id) {
    std::shared_ptr<simple::symbol> symbol = std::make_shared<simple::symbol>(new basic_type(4, basic_type::TYPE_INT), id, 0);
...
void simple::type_checker::do_program_node(simple::program_node * const node, int lvl) {
  // EMPTY
}
