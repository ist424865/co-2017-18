...
void simple::xml_writer::do_nil_node(cdk::nil_node * const node, int lvl) {
  // EMPTY
}
void simple::xml_writer::do_data_node(cdk::data_node * const node, int lvl) {
  // EMPTY
}
void simple::xml_writer::do_double_node(cdk::double_node * const node, int lvl) {
  // EMPTY
}
void simple::xml_writer::do_not_node(cdk::not_node * const node, int lvl) {
  // EMPTY
}
void simple::xml_writer::do_and_node(cdk::and_node * const node, int lvl) {
  // EMPTY
}
void simple::xml_writer::do_or_node(cdk::or_node * const node, int lvl) {
  // EMPTY
}
...
void simple::xml_writer::do_unary_expression(cdk::unary_expression_node * const node, int lvl) {
...
void simple::xml_writer::do_binary_expression(cdk::binary_expression_node * const node, int lvl) {
  ASSERT_SAFE_EXPRESSIONS;
  openTag(node, lvl);
...
void simple::xml_writer::do_identifier_node(cdk::identifier_node * const node, int lvl) {
  ASSERT_SAFE_EXPRESSIONS;
  os() << std::string(lvl, ' ') << "<" << node->label() << ">" << node->name() << "</" << node->label() << ">" << std::endl;
}

void simple::xml_writer::do_rvalue_node(cdk::rvalue_node * const node, int lvl) {
  ASSERT_SAFE_EXPRESSIONS;
  openTag(node, lvl);
...
void simple::xml_writer::do_assignment_node(cdk::assignment_node * const node, int lvl) {
  ASSERT_SAFE_EXPRESSIONS;
  openTag(node, lvl);
